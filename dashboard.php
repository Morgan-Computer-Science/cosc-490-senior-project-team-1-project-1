...
<h1 class="chat-title">Good Afternoon <?php echo $_SESSION["name"]; ?>!</h1>
...
<img src="assets/send_button.png" onclick="sendMessage()" class="send">
...
let reply=data.candidates?.[0]?.content?.parts?.[0]?.text || "AI unavailable"
...
preview.innerHTML=`<div class="attachment-item">📎 ${attachedFile.name}</div>`
...
await fetch("contact_support.php",{
method:"POST",
body:form
})
